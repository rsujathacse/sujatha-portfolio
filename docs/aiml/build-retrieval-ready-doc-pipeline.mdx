...
<figure style={{ textAlign: "center", margin: "2rem 0" }}>
  <img
    ...
    style={{ borderRadius: "12px", boxShadow: "0 4px 16px rgba(0,0,0,0.08)", maxWidth: "100%" }}
  />
  <figcaption style={{ marginTop: "0.75rem", fontSize: "0.9rem", color: "#666" }}>
    Creating a DigitalOcean Droplet (VM).
  </figcaption>
</figure>
<figure style={{ textAlign: "center", margin: "2rem 0" }}>
  <img
  ...
  />
  <figcaption style={{ marginTop: "0.75rem", fontSize: "0.9rem", color: "#666" }}>
    Created a DigitalOcean Droplet (VM).
  </figcaption>
</figure>
...
<figure style={{ textAlign: "center", margin: "2rem 0" }}> 
  <img 
  src="/img/aiml/docker-installed.png" 
...
docker compose ps
```
<figure style={{ textAlign: "center", margin: "2rem 0" }}> <img src="/img/aiml/docker-compose-running.png" alt="Docker compose ps output showing running FastAPI container" style={{ borderRadius: "12px", boxShadow: "0 4px 16px rgba(0,0,0,0.08)", maxWidth: "100%" }} /> <figcaption style={{ marginTop: "0.75rem", fontSize: "0.9rem", color: "#666" }}> FastAPI service running inside Docker. </figcaption> </figure>
...
<figure style={{ textAlign: "center", margin: "2rem 0" }}> <img src="/img/aiml/health-endpoint.png" alt="Terminal showing successful curl response from health endpoint" style={{ borderRadius: "12px", boxShadow: "0 4px 16px rgba(0,0,0,0.08)", maxWidth: "100%" }} /> 
...
<figure style={{ textAlign: "center", margin: "2rem 0" }}>
  <img
    src="/img/aiml/deploy-md-structure.png"
...
<figure style={{ textAlign: "center", margin: "2rem 0" }}> 
<img src="/img/aiml/chunks-generated.png" alt="Terminal showing chunks.json file generated successfully" style={{ borderRadius: "12px", boxShadow: "0 4px 16px rgba(0,0,0,0.08)", maxWidth: "100%" }} /> 
<figcaption style={{ marginTop: "0.75rem", fontSize: "0.9rem", color: "#666" }}> 
