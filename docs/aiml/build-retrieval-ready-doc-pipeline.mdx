...
<figure style={{ textAlign: "center", margin: "2rem 0" }}> <img src="/img/aiml/doc-pipeline/health-endpoint.png" alt="Terminal showing successful curl response from health endpoint" style={{ borderRadius: "12px", boxShadow: "0 4px 16px rgba(0,0,0,0.08)", maxWidth: "100%" }} /> 
...
<figure style={{ textAlign: "center", margin: "2rem 0" }}> 
<img src="/img/aiml/doc-pipeline/chunks-generated.png" alt="Terminal showing chunks.json file generated successfully" style={{ borderRadius: "12px", boxShadow: "0 4px 16px rgba(0,0,0,0.08)", maxWidth: "100%" }} /> 
<figcaption style={{ marginTop: "0.75rem", fontSize: "0.9rem", color: "#666" }}> 
